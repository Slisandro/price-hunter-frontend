...
const Landing = () => {
    return (
        <div className="hunter_landing_content">
                        ...
                        <div class="containerLanding ">
                            ...
                            <div class="grider__functions grid grid-3 text-center">
                                ...
                                <Card style={{ width: '23rem', height: '17rem' }} className="card-instructions">
                                    <CardBody >
                                        <CardTitle className="card_title_instructions">1</CardTitle>
                                ...
                                <Card style={{ width: '23rem', height: '17rem' }} className="card-instructions">
                                    <CardBody>
                                        <CardTitle className="card_title_instructions">2</CardTitle>
                                ...
                                <Card style={{ width: '23rem', height: '17rem' }} className="card-instructions">
                                    <CardBody>
                                        <CardTitle className="card_title_instructions">3</CardTitle>
                                ...
                                <Card style={{ width: '23rem', height: '17rem' }} className="card-instructions">
                                    <CardBody>
                                        <CardTitle className="card_title_instructions">4</CardTitle>
