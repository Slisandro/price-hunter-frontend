          ...
          <div className="containerSlider">
            <div className="data">
              ...
              <p className="description">
                Consiga grandes recompensas por cumplir con tareas gracias a
        ...
        <li>
          <div className="containerSlider">
            <div className="data">
              ...
              <p className="description">
                Consiga los mejores precios gracias a nuestros price hunters
              </p>
              <div className="buttons">
                <button>Saber más</button>
                <button>Unirte</button>
        ...
        <li>
          <div className="containerSlider">
            <div className="data">
              ...
              <p className="description">
                Consiga una recopilación de datos adaptable a los intereses para
                su empresa
              </p>
              <div className="buttons">
                <button>Saber más</button>
