      ...
      <div className="content">
              ...
              <CardHeader>
                <Row>
                  <Col className="text-left" sm="6">
                    <h5 className="card-category">Productos Totales</h5>
                    <CardTitle tag="h2">Rendimiento</CardTitle>
                  </Col>
                  <Col sm="6">
                    <ButtonGroup
        ...
        <Row>
          <Col lg="4">
            <Card className="card-chart">
              <CardHeader>
                <h5 className="card-category">Desafíos Totales</h5>
                <CardTitle tag="h3">
          ...
          <Col lg="4">
            <Card className="card-chart">
              <CardHeader>
                <h5 className="card-category">Puntos Acumulados</h5>
                <CardTitle tag="h3">
          ...
          <Col lg="4">
            <Card className="card-chart">
              <CardHeader>
                <h5 className="card-category">Desafíos Completados</h5>
                <CardTitle tag="h3">
                  <i className="tim-icons icon-send text-success" /> 1.200
                </CardTitle>
              </CardHeader>
              <CardBody>
                <div className="chart-area">
