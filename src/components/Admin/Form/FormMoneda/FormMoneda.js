      ...
      <Card className="card-chart">
        ...
        <CardBody>
          ...
          >
            ...
            <Row>
              <Col>
                <label className="title">Monedas Actuales</label>
                <Input
                  name="id"
                  type="select"
                  className="inp"
                ...
                <label className="title">Codigo de Moneda</label>
                <Input
                  // className="btm"
                  type="NaN"
                  className="inp"
                ...
                <div>
                  <label className="title">Nombre de la Moneda</label>
                  <Input
                    className="inp"
                    type="text"
                    max="0"
                ...
                <div>
                  <label className="title">Simbolo</label>
                  <Input
                    className="inp"
                    type="text"
                    name="simbolo"
